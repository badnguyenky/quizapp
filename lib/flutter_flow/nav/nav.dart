...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CountingPage',
          path: '/countingPage',
          builder: (context, params) => const CountingPageWidget(),
        ),
        FFRoute(
          name: 'SelectTagPage',
          path: '/selectTagPage',
          builder: (context, params) => const SelectTagPageWidget(),
        ),
        FFRoute(
          name: 'LoadingPage',
          path: '/loadingPage',
        ...
        FFRoute(
          name: 'QuizQuestion',
          path: '/quizQuestion',
          builder: (context, params) => const QuizQuestionWidget(),
        ),
        FFRoute(
          name: 'QuizPage',
          path: '/quizPage',
        ...
        FFRoute(
          name: 'EditTagPage',
          path: '/editTagPage',
          builder: (context, params) => const EditTagPageWidget(),
        ),
        FFRoute(
          name: 'UploadVideoPage',
          path: '/uploadVideoPage',
          builder: (context, params) => const UploadVideoPageWidget(),
        )
